...
const audio1 = new Audio('audios/vine-boom.mp3')
const audio2 = new Audio('audios/yeah-boiii-i-i-i.mp3')
...
function colisaoBolinha(){
    if(bolinha.py + bolinha.largura >= player2.py && bolinha.py <= player2.py + player1.largura && bolinha.px <= player2.px + player2.tamanho && bolinha.px >= player2.px - player2.tamanho){
        bolinha.dir *= -1
        audio1.play()
